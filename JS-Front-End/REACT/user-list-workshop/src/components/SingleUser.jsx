...
function SingleUser({user,deleteUser}) {
  ...
  if(showInfo){
    ...
    return <div>{showInfo && <UserInfo userId={user._id} disableInfoBtn={disableInfoBtn}/>}</div>
  }
  ...
  return (
    ...
    <tr>
          ...
          <td className="actions">
            ...
            <button onClick={()=>deleteUser(user._id)} className="btn delete-btn" title="Delete">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
            ...
            <button  onClick={()=>setShowInfo(true)} className="btn info-btn" title="Info">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
