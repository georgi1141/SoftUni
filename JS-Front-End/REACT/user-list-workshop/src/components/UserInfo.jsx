...
function UserInfo({disableInfoBtn,userId}) {
  ...
  return (
    <div onClick={()=>disableInfoBtn()} className="overlay">
      <div className="backdrop"></div>
      <div className="modal">
        <div className="detail-container">
          <header className="headers">
            <h2>User Detail</h2>
            <button onClick={()=>disableInfoBtn()} className="btn close">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
          ...
          <div className="content">
            ...
            <div className="user-details">
              ...
              <p>
                Created on: <strong>{parseISOStringToDateString(user.createdAt)}</strong>
              </p>
              <p>
                Modified on: <strong>{parseISOStringToDateString(user.updatedAt)}</strong>
              </p>
            </div>
          </div>
        </div>
